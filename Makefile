...
$(SOURCE_DIR)/binutils-02-patch-07-symbols-discarded-section.done: | $(SOURCE_DIR)/binutils-02-patch-06-delay-load.done
	patch -d $(SOURCE_DIR)/$(BINUTILS_SRC_DIR) -p1 <patches/binutils/Check-for-symbols-defined-in-discarded-section.patch
	@touch $@

$(BUILD_DIR)/binutils-03-configure.done: | $(SOURCE_DIR)/binutils-02-patch-07-symbols-discarded-section.done
